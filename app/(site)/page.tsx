...
export default function HomePage() {
  return (
    <>
      ...
      <section className="grid min-h-[600px] lg:grid-cols-2">
        ...
        <div className="relative flex items-center px-8 py-16 lg:px-16 lg:py-24">
          <div className="max-w-lg">
            ...
            <span className="mb-8 block rounded-full border border-pink px-3 py-1 text-[11px] font-bold text-pink w-fit">
              Printing Services
            </span>
        ...
        <div className="relative flex items-center bg-ink px-8 py-16 text-white lg:px-16 lg:py-24">
          <div className="max-w-lg">
            ...
            <span className="mb-8 block rounded-full border border-yellow-brand px-3 py-1 text-[11px] font-bold text-yellow-brand w-fit">
              Personalised Gifts
            </span>
            ...
            <div className="flex flex-wrap gap-3">
              <Link
                ...
                className="inline-flex items-center rounded-full bg-yellow-brand px-6 py-3 text-sm font-bold text-ink transition-colors hover:bg-yellow-200"
              >
                Shop Gifts
              </Link>
              <a
      ...
      {/* Scrolling category bar - placeholder */}
      <section className="overflow-hidden border-y-2 border-ink bg-pink py-4">
        <div className="flex animate-marquee gap-12 whitespace-nowrap text-xl font-black text-white">
          {['NAME CARDS', 'FLYERS', 'ROLL-UP BANNERS', 'STICKERS', 'EMBROIDERY', 'POLO SHIRTS', 'UV PRINTING'].map(
            (w, i) => (
              <span key={i}>— {w}</span>
            )
          )}
      ...
      <section className="bg-ink py-24 text-center text-white">
        <div className="mx-auto max-w-3xl px-6">
          ...
          <div className="mb-10 flex flex-col items-center gap-4 sm:flex-row sm:justify-center">
            ...
            >
              <span>💬</span> WhatsApp · +65 8553 3497
            </a>
          </div>
          <div className="flex flex-wrap justify-center gap-3 text-xs">
            ...
            <span className="rounded-full border border-white/20 px-4 py-2">✉️ hello@printvolution.sg</span>
