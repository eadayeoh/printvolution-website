...
const ncr = {
        ...
        },
        {
          ...
          side: {
            ...
            rows: [
              ...
              { text: "3 ply", time: "+ driver / warehouse" },
              { text: "4 ply", time: "+ finance / accounts" },
              { text: "5 ply", time: "+ regulatory filing" },
            ],
          },
        },
        {
  ...
  faqs: [
    ...
    { question: "Can I pick my own ink colours?", answer: "Yes — choose from the PT range: PT1 Royal Blue, PT2 Cyan, PT3 Bronze Red, PT4 Magenta, PT5 Orange 021, PT6 Green, PT7 Black. For 1-colour books, pick one. For 2-colour, pick two. Spot colours outside this range are a custom job — contact us for a quote." },
