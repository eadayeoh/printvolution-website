...
export const BATCH = [
  // hand-fan moved to scripts/rewrite-hand-fan-content.mjs (Apr 2026)
  // — its content is driven by the real 4-axis configurator now and
  // kept out of this batch so apply-all-content.mjs doesn't stomp it.
