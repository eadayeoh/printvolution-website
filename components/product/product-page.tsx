  ...
  return (
    <article>
      ...
      {(intro || product.highlights.length > 0 || product.specs.length > 0) && (
        <section style={{ background: '#fff', padding: '72px 24px', borderBottom: '1px solid var(--pv-rule)' }}>
          <div
            className="pv-about-grid"
            style={{
              maxWidth: 1560,
              margin: '0 auto',
              display: 'grid',
          ...
          >
            <div>
              ...
              <h2 style={{ fontFamily: 'var(--pv-f-display)', fontSize: 'clamp(28px, 3.5vw, 44px)', letterSpacing: '-0.02em', margin: 0, marginBottom: 18 }}>
                Why this one <span style={{ color: 'var(--pv-magenta)' }}>works so well.</span>
              </h2>
              {intro && (
                <p style={{ fontSize: 16, lineHeight: 1.7, color: 'var(--pv-ink-soft)', margin: 0, marginBottom: 22 }}>{intro}</p>
              )}
              {product.highlights.length > 0 && (
                <ul style={{ listStyle: 'none', padding: 0, margin: 0, display: 'grid', gap: 10 }}>
                  {product.highlights.map((h, i) => (
                    ...
                    >
                      <span style={{ width: 8, height: 8, background: 'var(--pv-magenta)', flexShrink: 0, marginTop: 8 }} />
                      {h}
                    </li>
                  ))}
                </ul>
                  ...
                  {product.specs.map((s, i) => (
                    <div
                      ...
                      style={{
                        ...
                        gap: 16,
                        paddingBottom: 8,
                        borderBottom: i === product.specs.length - 1 ? 'none' : '1px dashed var(--pv-rule)',
                      }}
                    >
                      <span
                        style={{
      ...
      {/* WHY US (dark) */}
      {whyUs.length > 0 && (
        <section style={{ background: 'var(--pv-ink)', color: '#fff', padding: '72px 24px' }}>
          <div style={{ maxWidth: 1560, margin: '0 auto' }}>
            <div
              style={{
                fontFamily: 'var(--pv-f-mono)',
